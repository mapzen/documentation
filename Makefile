...
VALHALLA_TEMP = https://github.com/valhalla/valhalla-docs/archive/rhonda-api-keys.tar.gz
...
src-mobility:
	mkdir src-mobility
	curl -sL $(VALHALLA_TEMP) | tar -zxv -C src-mobility --strip-components=1 valhalla-docs-rhonda-api-keys
