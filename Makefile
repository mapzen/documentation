...
VALHALLA = https://github.com/valhalla/valhalla-docs/archive/transit.tar.gz
...
src-mobility:
	mkdir src-mobility
	curl -sL $(VALHALLA) | tar -zxv -C src-mobility --strip-components=1 valhalla-docs-transit
