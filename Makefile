# Source doc tarballs
TANGRAM = https://github.com/tangrams/tangram-docs/archive/meetar/introductions.tar.gz
...
src-tangram:
	mkdir src-tangram
	curl -sL $(TANGRAM) | tar -zxv -C src-tangram --strip-components=2 tangram-docs-meetar-introductions/pages
